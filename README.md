...
Приложение построено по клиент-серверной архитектуре и состоит из веб-клиента на Vue.js и серверной части на Spring Boot. Сервер отвечает за аутентификацию пользователей, хранение зашифрованных данных и доставку сообщений, не имея доступа к их открытому содержимому.
